...
import com.droibit.looking2.ui.common.databinding.ListItemActionBinding
import com.droibit.looking2.ui.common.databinding.ListItemActionTitleBinding
...
class ActionItemListAdapter(
    ...
    private val itemPadding = com.droibit.looking2.ui.common.view.ShapeAwareContentPadding(context)
...
private fun inflateActionMenu(
    ...
    val menu = com.droibit.looking2.ui.common.view.ActionMenu(context).also {
